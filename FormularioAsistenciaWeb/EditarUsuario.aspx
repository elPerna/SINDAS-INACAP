<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditarUsuario.aspx.cs" Inherits="FormularioAsistenciaWeb.EditarUsuario" %>
            ...
            <div class="col-lg-13" runat="server" id="frmEditar">
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        ...
                        <div>
                            <asp:Label ID="lblmsgFrm" runat="server"></asp:Label>
                        </div>
                    </div>
